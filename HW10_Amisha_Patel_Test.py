...
class Test(unittest.TestCase):
    def test_data_for_Student(self):
        ...
        cal1: List = [['10103', 'Baldwin, C', ['CS 501', 'SSW 564', 'SSW 567', 'SSW 687']],
        ...
        cal2: List = [student.info() for cwid,student in self.stevens._students.items()]
        self.assertEqual(cal, cal1)
        self.assertNotEqual(cal, cal2)
    def test_data_for_Instructor(self):
        ...
        cal1: List = [['987656', 'Einstein, A', 'SFEN', 'SSW 567', 4],
                            ['98765', 'Einstein, A', 'SFEN', 'SSW 540', 3],
                            ['98764', 'Feynman, R', 'SFEN', 'SSW 564', 3],
                            ['98764', 'Feynman, R', 'SFEN', 'SSW 687', 3],
                            ['98764', 'Feynman, R', 'SFEN', 'CS 501', 1],
        ...
        self.assertNotEqual(stevens.instructor_pretty_table(), cal1)
    def test_data_for_Major(self):
        """This test function returns to test data for major function's table"""
        self.stevens: Repository = Repository("R:/Steven Institute/SSW -810-B/HW10")
        cal: List = [['SFEN', ['SSW 540', 'SSW 564', 'SSW 555', 'SSW 567'], ['CS 501', 'CS 513', 'CS 545']],
                            ['SYEN', ['SYS 671', 'SYS 612', 'SYS 800'], ['SSW 810', 'SSW 565', 'SSW 540']]]
        cal1: List = [['SFEN', ['SSW 540', 'SSW 564', 'SSW 555', 'SSW 567'], ['CS 501', 'CS 513', 'CS 545']],
                            ['SYEN', ['SYS 671', 'SYS 612', 'SYS 800'], ['SSW 810', 'SSW 565', 'SSW 541']]]
        cal2: List = [course.info() for major,course in self.stevens._majors.items()]
